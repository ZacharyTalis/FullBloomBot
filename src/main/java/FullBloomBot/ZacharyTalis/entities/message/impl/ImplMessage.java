 ...
 */
package FullBloomBot.ZacharyTalis.entities.message.impl;

import FullBloomBot.ZacharyTalis.entities.message.embed.Embed;
import FullBloomBot.ZacharyTalis.entities.message.embed.EmbedBuilder;
import FullBloomBot.ZacharyTalis.entities.message.embed.impl.ImplEmbed;
import FullBloomBot.ZacharyTalis.entities.permissions.Role;
import FullBloomBot.ZacharyTalis.listener.message.MessageDeleteListener;
import FullBloomBot.ZacharyTalis.listener.message.MessageEditListener;
...
import FullBloomBot.ZacharyTalis.entities.message.MessageAttachment;
import FullBloomBot.ZacharyTalis.entities.message.MessageReceiver;
import FullBloomBot.ZacharyTalis.entities.message.Reaction;
